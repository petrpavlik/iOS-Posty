...
// InboxSDK
#define COCOAPODS_POD_AVAILABLE_InboxSDK
#define COCOAPODS_VERSION_MAJOR_InboxSDK 0
#define COCOAPODS_VERSION_MINOR_InboxSDK 0
#define COCOAPODS_VERSION_PATCH_InboxSDK 2
